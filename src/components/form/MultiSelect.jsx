...
const MultiSelect = ({
  ...
  // Fixed: Added fallback to internalSelected
  ...
  const handleKeyDown = (e) => {
    ...
    // Note: Removed e.preventDefault() here globally, 
    // usually you only want to prevent default on specific keys handled below.
    
    switch (e.key) {
      case "Enter": // Fixed: Added colon
        e.preventDefault();
        if (!isOpen) {
          setIsOpen(true);
        ...
        break;
      case "Escape": // Fixed: Added colon
        e.preventDefault();
        setIsOpen(false);
        break;
      case "ArrowDown": // Fixed: Added colon
        e.preventDefault();
        if (!isOpen) {
          setIsOpen(true);
        } else {
        ...
        break;
      case "ArrowUp": // Fixed: Added colon
        e.preventDefault();
        if (isOpen) {
      ...
      <div className="relative z-20 inline-block w-full">
        <div className="relative flex flex-col items-center">
          <div
            ...
            className={`w-full mb-2 flex min-h-11 rounded-lg border border-gray-300 py-1.5 pl-3 pr-3 shadow-theme-xs outline-hidden transition focus:border-brand-300 focus:shadow-focus-ring dark:border-gray-700 dark:bg-gray-900 dark:focus:border-brand-300 ${
              disabled
